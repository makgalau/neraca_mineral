...
chaincodeInvoke() {
    ...
    peer chaincode invoke -o localhost:7050 \
        ...
        --peerAddresses localhost:10051 --tlsRootCertFiles $PEER0_BADANUSAHA2_CA \
        --peerAddresses localhost:11051 --tlsRootCertFiles $PEER0_THIRDPARTY_CA \
        -c '{"function": "CreateAsset","Args":["269","Nikel Gunung Nuih","Nikel","Ni","Logam Besi dan Paduan Besi","Gunung Nuih","Muara Samu","Paser","Kalimantan Timur","Eksplorasi","-","0","0","0","0","0","0","0","0","1202428","11783.7944","0","0","Kadar Ni 1,69%","115.766","-2.023","-","Swasta/BUMN","Test CPI","2024","CID21ewqewqe21","961db50c","test sk_agn","test sk_bgn","1","1","","verifikator/thirdparty",""]}'
