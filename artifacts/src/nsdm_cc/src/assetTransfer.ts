...
export class AssetTransferContract extends Contract {
    ...
    public async CreateAsset(ctx: Context, idLogam:string, namaobj:string, jnskom:string, 
        ...
        cpi:string,thn_update:number,cid_dataacuan:string, randGnum: string, sk_agn:string,sk_bgn:string,
        status_enc:number, status_validasi:number,filename: string, username:string, allowedAccessto:string): Promise<void> {
        ...
        const asset: AssetKomoditi = 
            {
                ...
                cid_dataacuan: cid_dataacuan,
                randGnum: randGnum,
                sk_agn: sk_agn,
                sk_bgn: sk_bgn,
                status_enc: status_enc,
                status_validasi: status_validasi,
                filename_acuan: filename, 
                username: username,
                allowedAccessto:allowedAccessto,
                last_updater : ''
            };
    ...
    public async UpdateAsset(ctx: Context, idLogam:string, namaobj:string, jnskom:string, 
        ...
        bjhTerbukti:number, logTerbukti:number, ket:string, lat:number,long:number,acuan:string, instansi:string,
        cpi:string, thn_update: number, cid_dataacuan:string, randGnum:string,sk_agn: string, sk_bgn:string,
        status_enc:number, status_validasi: number,filename:string,username:string,allowedAccessto:string,last_updater:string): Promise<void> {
        const exists = await this.AssetExists(ctx, idLogam);
            if (!exists) {
