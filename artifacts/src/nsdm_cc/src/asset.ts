...
export class AssetKomoditi {
    ...
    @Property()
    public cid_dataacuan: string;

    @Property()
    public randGnum: string;
    
    @Property()
    public sk_agn: string;

    @Property()
    public sk_bgn: string;

    @Property()
    public status_enc: number; //0 or 1

    @Property()
    public status_validasi: number;  //0 or 1

    @Property()
    public filename_acuan: string; 

    @Property()
    public username: string;
    
    @Property()
    public allowedAccessto: string;
